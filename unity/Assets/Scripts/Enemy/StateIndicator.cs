...
namespace Bradley.AlienArk
{
	public class StateIndicator : MonoBehaviour 
	{
		...
		protected virtual void UpdatePosition()
		{
			...
			transform.position = Vector2.Lerp(transform.position, Camera.main.ScreenToWorldPoint(screenPosition), 0.125f);
		}
		...
		protected virtual void UpdatePointer()
		{
			...
			m_pointer.transform.rotation = Quaternion.Lerp(rot, Quaternion.Euler(new Vector3(0,0,angle + rot.eulerAngles.z)), 0.125f);
		}
	}
}
